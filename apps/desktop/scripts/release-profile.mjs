...
export function resolveReleaseProfile(environment = process.env) {
  ...
  if (selected === DEVELOPMENT_PROFILE) {
    return Object.freeze({
      ...
      productName: "OhMyContext Developer Preview",
      executableName: "OhMyContextDeveloperPreview",
      setupExe: "OhMyContext-Developer-Preview-Unsigned-Setup.exe",
      squirrelName: "OhMyContextDeveloperPreview",
      packagedDirectoryName: "OhMyContext Developer Preview-win32-x64",
      description: "Unsigned developer preview for non-sensitive OhMyContext evaluation data.",
      copyright: "Copyright (c) OhMyContext project contributors",
      signing: undefined,
      updateUrl: undefined,
    });
  }
  ...
  const signing = {
    certificateFile,
    timestampServer,
    description: "OhMyContext local-first personal context",
    website,
    hashes: ["sha256"],
  };
  ...
  return Object.freeze({
    ...
    channel: "stable",
    version,
    productName: "OhMyContext",
    executableName: "OhMyContext",
    setupExe: "OhMyContext-Setup.exe",
    squirrelName: "OhMyContext",
    packagedDirectoryName: "OhMyContext-win32-x64",
    description: "Local-first personal context for AI clients.",
    copyright: "Copyright (c) NextH and OhMyContext contributors",
    updateUrl,
